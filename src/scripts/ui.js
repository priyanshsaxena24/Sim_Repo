...
export function updateFundsUI() {
  const fundsElement = document.getElementById('fund'); // Make sure you have this element in your HTML
  fundsElement.textContent = `Available Funds: $${window.globalAmount}`;
}
export class GameUI {
  /**
